...
public class TreeSort implements SortAlgorithm {
    ...
    public static void main(String[] args) {
        ...
        List<Integer> intList = Lists.newArrayList(3, -7, 45, 1, 343, -5, 2, 9);
        ...
        List<String> stringList = Lists.newArrayList("banana", "berry", "orange", "grape", "peach", "cherry", "apple", "pineapple");
